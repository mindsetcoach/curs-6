index.companyInfo = {
    ...
    render: function() {
        ...
        statisticsSectionEmployees.innerHTML =
            numberHandling.getNumberAsStringWithCommas(index.data.companyInfo.employees);
        ...
        statisticsSectionValuation.innerHTML =
            numberHandling.getNumberAsStringWithCommas(index.data.companyInfo.valuation);
